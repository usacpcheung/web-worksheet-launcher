...
- **Later-phase editor/viewer runtime direction (package-first/hybrid):** `worksheet_launcher_editor_viewer_spec.md`
- **Recommended backend schema direction + legacy/transitional mapping:** `worksheet_launcher_db_schema.md`
- **Architecture redesign plan (package-first hybrid, gaps, phases):** `docs/worksheet-architecture-redesign-plan.md`
...
- [`docs/worksheet-architecture-redesign-plan.md`](./worksheet-architecture-redesign-plan.md)
