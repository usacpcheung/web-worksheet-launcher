export default {
  ...
  "server": {
    ...
    "publishBody": "Choose a public title and optionally add a description for this uploaded RolePlayScene draft.",
    "publishTitleLabel": "Publish title",
    "publishDescriptionLabel": "Description (optional)",
    "publishDescriptionHint": "Briefly describe the situation, learning goals, or intended learners.",
  ...
  "published": {
    ...
    "search": "Search",
    "searchLabel": "Search title or description",
    "searchPlaceholder": "Search title or description",
    "ownerLabel": "Filter by owner name or email",
    "ownerPlaceholder": "Filter by owner name or email",
    "refresh": "Refresh",
    "loadMore": "Load more",
    "noScenes": "No published RolePlayScene scenes found.",
    "open": "Open in play mode",
    "editCopy": "Open as editable copy",
    "copyTitle": "{title} (copy)",
    "openedEditCopy": "Opened an editable local copy. The published original is unchanged.",
    ...
    "direct": {
      ...
      "signInDetail": "Sign in to continue opening this scene.",
  ...
  "messages": {
    ...
    "newStoryConfirmTitle": "Start a new story?",
    "newStoryConfirmBody": "This will replace the current locally saved story with a blank story. Export a backup first if you may need it later.",
    "newStoryConfirmAccept": "Start New Story",
    "newStoryStarted": "Started a new story.",
  ...
  "player": {
    ...
    "discussion": {
      ...
      "printDetailsTitle": "Print details",
      "printSchoolName": "School name",
      ...
      "printStudentNamePlaceholder": "Enter student name",
      "printDetailsCancel": "Cancel",
      "printDetailsPrint": "Print",
