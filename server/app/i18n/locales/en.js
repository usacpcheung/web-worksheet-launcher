...
export default {
  ...
  "common": {
    ...
    "meta": {
      "artifactSize": "Artifact Size {value}",
    ...
    "values": {
      ...
      "unknownUploadTime": "Unknown upload time",
      "untitled": "Untitled",
      "untitledWorksheet": "Untitled worksheet"
    }
  },
  "auth": {
    "signInForServerFeatures": "Sign in for server features"
  },
  "editor": {
    "actions": {
    ...
    "server": {
      ...
      "uploadingDraftPackage": "Uploading draft package...",
  ...
  "viewer": {
    ...
    "voice": {
      ...
      "stop": "Stop",
      "cancel": "Cancel",
      "locked": "Your answer is read-only until processing finishes. You can cancel at any time.",
      "atEnd": "Voice text will be added at the end. Place the cursor to choose another position.",
      "atCursor": "Voice text will be added at the cursor.",
      "ready": "Ready to edit",
      "recoveryText": "Recovered text",
      "retryRewrite": "Retry rewrite",
      "retryRecording": "Try again",
      "insert": "Add to answer",
      "append": "Add at end",
      "signIn": "Sign in",
      "discard": "Discard",
      "noRoom": "Your answer is at its limit. Shorten it before adding voice text.",
      "finishFirst": "Finish or cancel processing before submitting.",
      "otherQuestion": "{stage} Question {number}. Finish or cancel before starting another voice input or rewrite.",
      "stages": {
        "checking_session": "Checking sign-in…",
      ...
      "errors": {
        "AUTH_REQUIRED": "Please sign in, then press Try again. Recording will not start automatically.",
        "PERMISSION_DENIED": "Microphone permission was denied. Allow access in your browser, then try again.",
        "DEVICE_UNAVAILABLE": "No microphone is available. Check your microphone and try again.",
        "RECORDING_UNSUPPORTED": "Voice recording is unavailable. Use a supported browser over HTTPS, or type your answer.",
        "RECORDER_ERROR": "Recording was interrupted. Please try again.",
        "EMPTY_RECORDING": "No audio or text was captured. Please try again.",
        "RECORDING_TOO_LONG": "The recording exceeded one minute. Please record a shorter segment.",
        "UPLOAD_TOO_LARGE": "The recording is too large. Please record a shorter segment.",
        "RATE_LIMITED": "Too many requests. Wait before trying again.",
        "BUSY": "Another request is already processing. Wait before trying again.",
        "TRANSCRIPT_TOO_LONG": "The transcript exceeds 2,000 characters. Shorten it before rewriting.",
        "ANSWER_TOO_LONG": "This addition exceeds the question limit. Shorten the recovered text before adding it.",
        "STALE_CONTEXT": "Your answer changed. Review the recovered text and explicitly add it at the end, or discard it.",
        "CANCELED": "Processing was cancelled here. Work already accepted by the service may still complete.",
        "ABORTED": "Processing was cancelled here. Work already accepted by the service may still complete.",
        "REWRITE_FAILED": "Rewriting did not finish. You can edit the transcript and retry rewriting without transcribing again.",
        "TRANSCRIPTION_FAILED": "Transcription did not finish. Please try again. Work already accepted by the service may still complete.",
        "SESSION_FAILED": "The sign-in check did not finish. Check your connection and try again.",
        "RECOVERED": "A transcript was recovered from this attempt. Review it before retrying rewrite."
      }
    },
    "start": {
      "title": "Start Viewer",
      "description": "Resume attempts, import a worksheet, or load a published online version.",
      "attempts": "Attempts",
    ...
    "actions": {
      ...
      "previousBlock": "Go to previous block",
      "nextBlock": "Go to next block",
      "previousBlockTitle": "Previous block",
    ...
    "inputHelper": {
      ...
      "multipleChoiceSingle": "Choose one option only.",
      "numberBase": "Enter integer/decimal only (fractions like 2/3 are not supported).",
      "numberMaximum": "maximum {value}",
      "numberMinimum": "minimum {value}",
      "numberRangeSuffix": " Range: {range}.",
      "text": "Text response."
    },
    "print": {
    ...
    "stepper": {
      ...
      "instructionNumber": "Instruction Number {number}",
      "question": "Question",
      "questionNumber": "Question Number {number}"
    },
    "summary": {
      "answered": "Answered {answered}/{total}",
      "checked": "Checked {correct}/{total} correct",
