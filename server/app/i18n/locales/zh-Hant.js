...
export default {
  ...
  "common": {
    ...
    "publishedBrowser": {
      ...
      "openPackage": "開啟套件",
      "empty": "沒有已發布套件",
      "filterByOwnerAriaLabel": "按擁有者篩選",
      "filterByOwnerEmail": "擁有者電郵",
      "filterBySubject": "按科目篩選",
      "filterBySubjectAriaLabel": "按科目篩選",
      "filterByTitle": "按標題篩選",
      "filterByTitleAriaLabel": "按標題篩選",
      "loading": "載入中",
      "searchAriaLabel": "搜尋已發布套件",
      "signInToLoad": "登入以載入"
    },
    "language": {
      "label": "語言",
    ...
    "meta": {
      "artifactSize": "檔案大小 {value}",
      "checked": "已檢查 {value}",
      "packageId": "套件 ID {value}",
      "status": "狀態 {value}",
      "subject": "科目 {value}",
      "submitted": "已提交 {value}",
      "updated": "已更新 {value}",
    ...
    "values": {
      ...
      "unknown": "未知",
      "unknownTime": "未知時間",
      "unknownUploadTime": "未知上載時間",
      "untitled": "未命名",
      "untitledWorksheet": "未命名工作紙"
    }
  },
  "auth": {
    "signInForServerFeatures": "登入以使用伺服器功能"
  },
  "editor": {
    "actions": {
    ...
    "server": {
      "uploadDraft": "上載草稿",
      "uploadingDraftPackage": "正在上載草稿套件...",
    ...
    "uploadedDraft": {
      ...
      "deleteDialog": {
        ...
        "publishedDescription": "已發布版本會保留，除非你也選擇移除已發布資料。",
        "removeArtifact": "移除套件檔案",
        "removeMetadata": "移除草稿資料",
        "title": "刪除已上載草稿"
      },
      "empty": "沒有已上載草稿",
      "loading": "載入中",
      "metaDraftId": "草稿 ID {value}",
      "metaPublishState": "發布狀態 {value}",
      "metaPublishedId": "已發布 ID {value}",
      "publishBadge": {
        "deleted": "已刪除",
        "deletedHelp": "此已發布版本已被刪除。",
        "live": "已上線",
        "liveHelp": "此草稿已有已發布版本。",
        "notPublished": "未發布",
        "updated": "已更新"
    ...
    "block": {
      ...
      "contentTextPlaceholder": "輸入要顯示給學生的內容。",
      "copyAssetId": "複製資源 ID",
      "copyBlockId": "複製區塊 ID",
      "deleteBlockAriaLabel": "刪除第 {index} 個區塊",
      "deleteConfirm": "確認刪除",
      "deleteDialogTitle": "刪除第 {index} 個區塊",
      "deleteThisBlock": "刪除此區塊",
      "emptyState": "尚未新增任何區塊。",
      "entityLabel": "第 {index} 個區塊",
      "promptAudioAssetId": "題目音訊資源 ID",
    ...
    "labels": {
      "lastSaved": "上次儲存",
      "localDraftId": "本機草稿 ID"
    },
    "modal": {
      "confirm": {
        "defaultDescription": "請確認你要繼續。",
        "deleteEntity": "刪除 {entity}",
        "irreversibleWarning": "此操作無法復原。",
        "thisWillRemove": "這會移除"
      },
      "publish": {
        "description": "發布後，學生可透過檢視器開啟此工作紙。",
        "publishedSubject": "已發布科目",
        "publishedTitle": "已發布標題",
        "title": "發布工作紙"
      },
      "publishConflict": {
        "description": "此草稿已有已發布版本。你可以更新名稱和科目後再發布。",
        "editNameSubject": "編輯名稱和科目",
        "title": "發布衝突",
        "warning": "發布會建立新的線上版本。"
      },
      "slotLimit": {
        "description": "你已達到可上載草稿數量上限。請先刪除不需要的草稿。",
        "title": "草稿空位已滿"
      },
      "uploadConflict": {
        "description": "「{title}」已有已上載草稿。",
        "replaceUploadedDraft": "取代已上載草稿",
        "saveAsNewCopy": "另存為新副本",
        "statusAlreadyPublished": "已發布",
        "statusDraftOnly": "僅草稿",
        "title": "已存在上載草稿",
        "warningPublishedCopyUnaffected": "已發布版本不會受影響。",
        "warningReplaceArtifact": "取代後，現有草稿套件會被覆蓋。"
      }
    },
    "notifications": {
      "auth": {
    ...
    "option": {
      "add": "新增選項",
      "includeInCorrectAnswers": "加入正確答案",
      "markAsCorrectAnswer": "標記為正確答案",
      "placeholder": "選項 {index}",
      "sectionTitle": "選項",
      "toggleCorrectAnswerAriaLabelMulti": "切換第 {index} 個選項是否為正確答案",
      "toggleCorrectAnswerAriaLabelSingle": "將第 {index} 個選項標記為正確答案"
    },
    "question": {
      "allowSignedValues": "允許正負號",
      "answerInputType": "答案輸入類型",
      "answerSectionTitle": "答案",
      "correctAnswer": "正確答案",
      "decimalPlaces": "小數位數",
      "decimalPlacesHint": "留空表示不限制小數位數。",
      "max": "最大值",
      "maxLength": "最大長度",
      "min": "最小值",
      "responseFormat": "作答格式",
    ...
    "reorder": {
      ...
      "dragHandleTitle": "拖曳第 {index} 個區塊",
      "menuAriaLabel": "第 {index} 個區塊選單",
      "moreActionsAriaLabel": "第 {index} 個區塊的更多操作",
      "moreActionsTitle": "第 {index} 個區塊的更多操作",
      "moveDown": "下移",
  ...
  "viewer": {
    ...
    "voice": {
      ...
      "stop": "停止",
      "cancel": "取消",
      "locked": "處理期間答案暫時唯讀。你可以隨時取消。",
      "atEnd": "語音文字會加入答案末尾。移動游標可選擇其他位置。",
      "atCursor": "語音文字會加入游標所在位置。",
      "ready": "可以編輯了",
      "recoveryText": "保留的文字",
      "retryRewrite": "重試改寫",
      "retryRecording": "重試",
      ...
      "signIn": "登入",
      "discard": "捨棄",
      "noRoom": "答案已達字數上限。請先縮短答案。",
      "finishFirst": "請完成或取消處理後再提交。",
      "otherQuestion": "{stage} 第 {number} 題。請先完成或取消，再開始另一項語音輸入或改寫。",
      "stages": {
        "checking_session": "正在檢查登入…",
        "requesting_permission": "等候麥克風權限…",
        "recording": "錄音中",
        "stopping": "正在結束錄音…",
        "transcribing": "正在上傳及轉錄…",
        "rewriting": "正在改寫…"
      },
      "errors": {
        "AUTH_REQUIRED": "請登入後再按「重試」。錄音不會自動開始。",
        "PERMISSION_DENIED": "麥克風權限被拒絕。請在瀏覽器允許存取後重試。",
        "DEVICE_UNAVAILABLE": "未能使用麥克風。請檢查麥克風後重試。",
        "RECORDING_UNSUPPORTED": "未能使用語音錄音。請使用支援的瀏覽器及 HTTPS，或輸入答案。",
        "RECORDER_ERROR": "錄音中斷。請重試。",
        "EMPTY_RECORDING": "沒有錄到聲音或取得文字。請重試。",
        "RECORDING_TOO_LONG": "錄音超過一分鐘。請錄製較短的片段。",
        "UPLOAD_TOO_LARGE": "錄音檔案太大。請錄製較短的片段。",
        "RATE_LIMITED": "要求過於頻密。請稍候再試。",
        "BUSY": "另一項要求仍在處理。請稍候再試。",
        "TRANSCRIPT_TOO_LONG": "轉錄文字超過 2,000 字。請縮短後再改寫。",
        "ANSWER_TOO_LONG": "加入後會超出題目字數上限。請先縮短保留的文字。",
        "STALE_CONTEXT": "答案已更改。請檢查保留的文字，再選擇加入末尾或捨棄。",
        "CANCELED": "已在此取消處理。服務已接受的工作仍可能繼續完成。",
        "ABORTED": "已在此取消處理。服務已接受的工作仍可能繼續完成。",
        "REWRITE_FAILED": "未能完成改寫。你可以編輯轉錄文字，再重試改寫，毋須重新轉錄。",
        "TRANSCRIPTION_FAILED": "未能完成轉錄。請重試。服務已接受的工作仍可能繼續完成。",
        "SESSION_FAILED": "未能完成登入檢查。請檢查連線後重試。",
        "RECOVERED": "已還原這次作答的轉錄文字。請檢查後再重試改寫。"
      }
    },
    "start": {
      "title": "啟動檢視器",
      "description": "繼續作答、匯入工作紙，或載入已發布的網上版本。",
      "attempts": "作答記錄",
      "worksheets": "工作紙",
    ...
    "actions": {
      ...
      "submit": "提交",
      "checkAnswer": "檢查答案",
      "previousBlock": "前往上一個區塊",
      "nextBlock": "前往下一個區塊",
      "previousBlockTitle": "上一個區塊",
      "nextBlockTitle": "下一個區塊"
    },
    "attemptConflict": {
      "description": "「{title}」已有伺服器作答記錄。",
      "replaceServerAttempt": "取代伺服器作答記錄",
      "title": "作答記錄已存在",
      "warning": "取代後，現有伺服器作答記錄會被覆蓋。"
    },
    "attemptDelete": {
      "description": "你即將刪除「{title}」的伺服器作答記錄。",
      "title": "刪除作答記錄",
      "warning": "此操作無法復原。"
    },
    "attemptSlots": {
    ...
    "check": {
      ...
      "greatWork": "做得好",
      "incorrect": "不正確",
      "missingAnswerKey": "缺少答案",
      "notGraded": "未評分",
      "notQuite": "未完全正確",
      "reveal": {
        "correctAnswer": "正確答案：{answer}",
        "incorrectWithCorrectAnswer": "不正確。正確答案：{answer}",
        "noAnswer": "未作答",
    ...
    "inputHelper": {
      ...
      "numberMaximum": "最大值 {value}",
      "numberMinimum": "最小值 {value}",
      "numberRangeSuffix": " 範圍：{range}。",
      "text": "文字作答。"
    },
    "print": {
      "answerHeading": "答案",
      ...
      "noPromptProvided": "沒有題目內容",
      "notAnswered": "未作答",
      "printReportAriaLabel": "列印報告",
      "printReportTitle": "列印報告",
      "questionHeading": "題目",
      "questionImageAlt": "題目圖片",
      "questionImageUnavailable": "題目圖片無法使用",
      "questionNumber": "第 {number} 題",
      "reportTitleSuffix": "作答報告",
      "worksheetFallbackTitle": "工作紙"
    },
    "published": {
      "metaSubjectOwner": "科目 {subject}，擁有者 {owner}"
    },
    ...
    "rewrite": {
      "action": "改寫",
      "couldNotStart": "無法開始改寫",
      "hintEnterText": "請先輸入文字答案。",
      "hintTooLong": "文字太長，最多 {max} 個字元。",
      "inProgress": "改寫中",
      "noActiveAttempt": "沒有進行中的作答記錄",
      "onlyForTextResponse": "只適用於文字作答",
      "temporarilyUnavailableSessionCheck": "正在檢查登入狀態，暫時無法使用。",
      "temporarilyUnavailableWithReason": "暫時無法使用：{reason}",
      "undo": "復原"
    },
    "serverAttempts": {
      "deleting": "刪除中",
      "description": "查看、下載或刪除已上載的伺服器作答記錄。",
      "downloading": "下載中",
      "empty": "沒有伺服器作答記錄",
      "loading": "載入中",
    ...
    "shell": {
      "blockProgressAriaLabel": "區塊進度"
    },
    "status": {
      "finalizedAt": "已提交{time}",
      "finalizing": "正在完成提交...",
      "savedAt": "已儲存{time}",
      "saving": "儲存中..."
    },
    "stepper": {
      "content": "內容",
      "instruction": "說明",
      "instructionNumber": "第 {number} 個說明",
      "question": "題目",
      "questionNumber": "第 {number} 題"
    },
    "summary": {
      "answered": "已作答 {answered}/{total}",
      "checked": "已檢查正確 {correct}/{total}",
      "status": "狀態 {status}",
      "student": "學生 {name}"
    },
    "upload": {
