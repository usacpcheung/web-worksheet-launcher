...
const prepareIndex = mainSource.indexOf('preparedImport = await prepareProjectImport(file)');
const confirmIndex = mainSource.indexOf('const shouldImport = await confirmProjectImport()');
const applyIndex = mainSource.indexOf('applyPreparedProjectImport(store, preparedImport)');
